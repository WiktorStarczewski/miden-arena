...
mod tests {
    ...
    fn specific_encode_values() {
        ...
        // (9,1) -> 20
        assert_eq!(
            encode_move(&TurnAction { champion_id: 9, ability_index: 1 }),
            20
        );
    }
